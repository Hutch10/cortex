...
ot_present_in_source_schema).

## Relationships & First-Class Citations
Later outcomes or reflections remain append-only Grade B material related via a neutral ppended_to relationship. 
...
* **Simplification**: Removed complex causal relationships (outcome_of); standardized on ppended_to, cites, and derived_from.
